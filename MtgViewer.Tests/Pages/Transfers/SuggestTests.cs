...
public sealed class SuggestTests : IAsyncLifetime, IDisposable
{
    ...
    public async Task PickUser_ValidUser_ShowDecks()
    {
        ...
        var receiver = await _dbContext.Players
    ...
    private async Task AddExtraReceiverDecksAsync(Player receiver)
    {
    ...
    private async Task AddReceiverDeckAsync(Player receiver)
    {
